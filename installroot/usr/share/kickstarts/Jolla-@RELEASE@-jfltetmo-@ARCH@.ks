# DisplayName: Jolla jfltetmo/@ARCH@ (release) 1
# KickstartType: release
# DeviceModel: jfltetmo
# DeviceVariant: jfltetmo
...
repo --name=adaptation-community-common-jfltetmo-@RELEASE@ --baseurl=http://repo.merproject.org/obs/nemo:/devel:/hw:/common/sailfish_latest_@ARCH@/
...
%packages
@Jolla Configuration jfltetmo
%end

%attachment
### Commands from /tmp/sandbox/usr/share/ssu/kickstart/attachment/jfltetmo
